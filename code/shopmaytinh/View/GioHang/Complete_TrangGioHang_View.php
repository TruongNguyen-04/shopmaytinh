...
<body>
    ...
    <div class="container">
        <div class="cart-container">
            ...
            <?php
            // Check if cart exists, if not show empty message
                                ...
                                <div class="col-md-3">
                                    <div class="quantity-controls">
                                        ...
                                        <input type="number" 
                                               ...
                                               min="1" 
                                               onchange="updateQuantity(<?php echo $item['id']; ?>, this.value - <?php echo $item['quantity']; ?>)">
                                        <button class="quantity-btn" onclick="updateQuantity(<?php echo $item['id']; ?>, 1)">
                        ...
                        <form method="POST" action="../../process_order.php">
                            <div class="form-group">
                                ...
                                <input type="text" 
                                       ...
                                       name="tenNguoiNhan" 
                                       required
                                       value="<?php echo isset($_SESSION['user_info']['TenDangNhap']) ? htmlspecialchars($_SESSION['user_info']['TenDangNhap']) : ''; ?>">
                            </div>
                            ...
                            <div class="payment-methods">
                                ...
                                <div class="payment-option" onclick="selectPayment('momo')">
                                    ...
                                    <label for="momo" style="cursor: pointer; margin: 0; display: flex; align-items: center;">
                                        <div class="momo-logo">Mo</div>
                                        <div>
                                            <strong>Ví MoMo</strong>
                                            <br>
                                            <small class="text-muted">Thanh toán nhanh chóng và an toàn</small>
                                        </div>
                                    </label>
                                </div>
                                ...
                                <div class="payment-option" onclick="selectPayment('cod')">
                                    ...
                                    <label for="cod" style="cursor: pointer; margin: 0; display: flex; align-items: center;">
                                        <i class="fas fa-money-bill-wave" style="font-size: 2rem; color: #27ae60; margin-right: 15px;"></i>
                                        <div>
    ...
    <script>
        ...
        function updateQuantity(id, change) {
            // This would normally update via AJAX
            console.log('Update quantity for item', id, 'by', change);
        }
        
        function removeItem(id) {
            if (confirm('Bạn có chắc muốn xóa sản phẩm này?')) {
                // This would normally remove via AJAX
        ...
        document.querySelector('form').addEventListener('submit', function(e) {
            ...
            if (paymentMethod.value === 'momo') {
                if (confirm('Bạn sẽ được chuyển đến trang thanh toán MoMo. Tiếp tục?')) {
