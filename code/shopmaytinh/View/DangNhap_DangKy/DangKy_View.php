...
<div class="to">
    <form class="form" name="form" method="POST" style="height: 445px;" novalidate>
        <h2>Đăng Ký</h2>
        
            <a href="index.php?action=nccdk"><small>Đăng ký là nhà cung cấp?</small></a>
       
       <!--  <i class="fab fa-app-store-ios"></i> -->
        <label style="margin-top: 10px">Tên Đăng Nhập</label>
        ...
        <label style="margin-left: -160px;margin-top: 10px;">Mật Khẩu</label>
...
<!-- 
        ...
        <input id="login" type="submit" style="width: 110%;" name="signup" value="Đăng Ký">
